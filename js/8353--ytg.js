...
function setDisplay (value) {
    ...
    function appendImages (result) {
        ...
        document.getElementById("hdreslink").href = "https://thumbnailphoto.net/download.php?id=" + result + "&quality=HD";
        document.getElementById("sdreslink").href = "https://thumbnailphoto.net/download.php?id=" + result + "&quality=SD";
        document.getElementById("hqreslink").href = "https://thumbnailphoto.net/download.php?id=" + result + "&quality=HQ";
        document.getElementById("mqreslink").href = "https://thumbnailphoto.net/download.php?id=" + result + "&quality=MQ";
				document.getElementById("defreslink").href = "=https://thumbnailphoto.net//download.php?id=" + result + "&quality=def";
